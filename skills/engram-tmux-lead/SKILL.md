...
Run the health check opportunistically — on user input and when processing agent messages. No background trigger loop needed.
...
3. **Drain on shutdown.** At session end (Section 3.4), drain all tracked task IDs: `CHAT_MONITOR_TASK_ID`.
