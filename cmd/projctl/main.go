...
func main() {
	targ.Main(
		...
		targ.Group("issue",
			targ.Targ(issueCreate).Name("create").Description("Create a new issue"),
			targ.Targ(issueUpdate).Name("update").Description("Update an existing issue"),
			targ.Targ(issueList).Name("list").Description("List issues"),
			targ.Targ(issueGet).Name("get").Description("Get issue details"),
		),
		...
		targ.Group("memory",
			...
			targ.Targ(memoryConsolidate).Name("consolidate").Description("Perform periodic memory maintenance"),
			targ.Group("hooks",
