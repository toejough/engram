...
func main() {
	targ.Main(
		targ.Group("state",
			...
			targ.Group("pair",
				targ.Targ(statePairSet).Name("set").Description("Set pair loop state for a phase or task"),
				targ.Targ(statePairClear).Name("clear").Description("Clear pair loop state"),
			),
			targ.Group("yield",
				targ.Targ(stateYieldSet).Name("set").Description("Set pending yield state"),
				targ.Targ(stateYieldClear).Name("clear").Description("Clear pending yield"),
			),
		),
		targ.Group("log",
		...
		targ.Group("yield",
			...
			targ.Targ(yieldTypes).Name("types").Description("List valid yield types"),
		),
		targ.Group("id",
