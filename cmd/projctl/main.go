...
func main() {
	targ.Main(
		...
		targ.Group("memory",
			...
			targ.Targ(memoryScoreSession).Name("score-session").Description("Score session surfacing events for faithfulness"),
			...
			targ.Targ(memoryDiagnose).Name("diagnose").Description("Diagnose leech memories and recommend remediation actions"),
