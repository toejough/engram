...
func StartRun(t _imptest.TestReporter, fn func(context.Context, surface.Store, surface.Formatter, surface.AuditLog, string, string, int) (string, error), ctx context.Context, st surface.Store, formatter surface.Formatter, auditLog surface.AuditLog, hookType string, query string, budget int) *StartRunCallHandle {
	...
	go func() {
		...
		ret0, ret1 := fn(ctx, st, formatter, auditLog, hookType, query, budget)
