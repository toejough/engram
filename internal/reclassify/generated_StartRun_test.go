...
func (h *StartRunCallHandle) ReturnsEqual(v0 int, v1 error) {
	h.T.Helper()
	h.WaitForResponse()
...
func StartRun(t _imptest.TestReporter, fn func(context.Context, reclassify.Store, reclassify.AuditLog, float64) (int, error), ctx context.Context, st reclassify.Store, auditLog reclassify.AuditLog, decayFactor float64) *StartRunCallHandle {
	...
	go func() {
		...
		ret0, ret1 := fn(ctx, st, auditLog, decayFactor)
