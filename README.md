...
engram show <ref> [--ref <ref>...]   Print a note (frontmatter + body + outbound wikilink targets), read-only. (candidate_l2s carry content inline, so /recall no longer shows candidates.)
