...
flowchart TB
    ...
    subgraph PU[engram update — process]
      upd["K9 · update<br/>go install + copy agent-instructions/{skills,commands}; --with-guidance adds agent-instructions/guidance (Claude Code, Pi)"]
    end
