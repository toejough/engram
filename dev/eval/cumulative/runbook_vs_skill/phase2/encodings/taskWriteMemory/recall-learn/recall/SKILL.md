...
Run `engram show 6a.2026-09-22.write-memory-compose-execute-verify` in Bash (a shell command — write-memory is not a Skill tool) and follow what it prints, handing it ONE synthesis note per conclusion (kind=fact or feedback, per the conclusion's shape):
...
ALSO run `engram show 6a.2026-09-22.write-memory-compose-execute-verify` in Bash (a shell command — write-memory is not a Skill tool) and follow what it prints** with kind=qa — verbatim question, the synthesis conclusion
