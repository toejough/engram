...
TARGET_DIR="$1"
TEMPLATE="$(cd "$(dirname "${BASH_SOURCE[0]}")/../fixture-repo-templates/opsx-archive-task" && pwd)"
...
git add -A
git commit -qm "chore: widget service with a completed, unarchived rate-limiting change"
