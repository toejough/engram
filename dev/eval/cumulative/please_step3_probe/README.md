...
Headless micro-test for the (retired) `please` skill's Step 3 (Plan) enumeration-grep step and
...
Usage:
```bash
python3 run_probe.py --skill-text ../please_step7_probe/skill-text/please-SKILL.md.frozen --n 3 \
    --out results/red_baseline.jsonl --model sonnet

python3 run_probe.py --skill-text ../please_step7_probe/skill-text/please-SKILL.md.frozen --loaded --n 1 \
