...
- **[CANONICAL — recall Steps 2.5C and 4 cross-reference this rule; do not move without updating those pointers] If the new lesson CORRECTS, narrows, or refutes an existing vault note**, add
