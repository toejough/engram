...
| <a id="s2-n3-engram-cli-binary"></a>S2-N3 | engram CLI binary | Container | Go binary that performs recall, learn, transcript, build-self. Refined in c3-engram-cli-binary.md. | — |
