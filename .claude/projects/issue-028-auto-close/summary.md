...
**Issue:** ISSUE-28 - Issue closure should be automatic when linked work completes
**Workflow:** task
**Status:** complete
...
Also closed ISSUE-30 (create issue-update-producer skill) as "won't do" - over-engineering for a one-liner.

## Changes

1. `skills/project/SKILL-full.md` - Added explicit bash snippet for auto-close
2. `docs/issues.md` - Closed ISSUE-28, ISSUE-30

## Commits

- `cb16eb0` - docs: make issue auto-close explicit in orchestrator
- `b134e5a` - fix: use macOS-compatible grep in issue auto-close
- `50b1c83` - chore: close ISSUE-28 and complete project
